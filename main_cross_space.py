...
def main():
    ...
    file_path = {}
    file_path['LR'] = '/media/ser606/Data/Lihu/LapSRN/trainingset_pre/LR_npy'
    file_path['x2'] = '/media/ser606/Data/Lihu/LapSRN/trainingset_pre/x2_npy'
    file_path['x4'] = '/media/ser606/Data/Lihu/LapSRN/trainingset_pre/x4_npy'
...
def train(training_data_loader, optimizer, model, criterion, epoch):
    ...
    image_list = glob.glob('/media/ser606/Data/Lihu/LapSRN/Set5' + "/*.*")
